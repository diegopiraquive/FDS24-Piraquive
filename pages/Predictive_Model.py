...
def calculate_upfront_charges(rate_of_interest, loan_amount):
    ...
    Utilizes training data for weighted calculations.
    """
    ...
    if not filtered_data.empty:
        # Calculate weights based on similarity to rate_of_interest
    ...
    # Fallback: Return mean upfront charges if no matching data is found
